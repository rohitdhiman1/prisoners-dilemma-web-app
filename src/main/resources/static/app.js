                ...
                <div className="right-panel">
                    ...
                    {!game.gameOver && (
                        <div className="buttons">
                            <button onClick={() => playMove('COOPERATE')} disabled={loading}>Cooperate</button>
                            <button onClick={() => playMove('DEFECT')} disabled={loading}>Defect</button>
                        </div>
                    )}
                    {game.gameOver && (
